...
show_title() {
    ...
    print_centered "╚══════════════════════════════════════════════════╝" "$BRIGHT_RED"
    echo ""
    print_centered "           ⚬⚬⚬" "$BROWN"
    print_centered "         ⚬ ● ⚬          ON  TOP" "$BROWN"
    print_centered "        ⚬ ╱≈╲ ⚬" "$BROWN"
    print_centered "       ⚬ ╱≈≈≈╲ ⚬             OF" "$BROWN"
    print_centered "      ⚬ ╱≈≈≈≈≈╲ ⚬" "$BROWN"
    print_centered "       │≈≈≈≈≈≈≈│       SPAGHETTI" "$YELLOW"
    print_centered "       ╲≈≈≈≈≈≈≈╱" "$YELLOW"
    print_centered "        ╲≈≈≈≈≈╱" "$YELLOW"
    print_centered "         ╲≈≈≈╱" "$YELLOW"
    print_centered "          ╲_╱" "$YELLOW"
    echo ""
    print_centered "♪  A Musical Tale in ASCII  ♪" "$CYAN"
    print_centered "(With 8-bit Chiptune Music!)" "$GRAY"
    echo ""
    print_centered "╔══════════════════════════════════════════════════╗" "$BRIGHT_RED"
    print_centered "║     ♪ ♫ ♪ ♫ ♪ ♫ ♪ ♫ ♪ ♫ ♪ ♫ ♪ ♫ ♪ ♫            ║" "$BRIGHT_RED"
    print_centered "╚══════════════════════════════════════════════════╝" "$BRIGHT_RED"
...
scene1() {
    ...
    echo ""
    echo -e "           ${GRAY}╔════════════════════════════════════╗${NC}"
    echo -e "           ${GRAY}║${NC}  ${CYAN}Dining Room - Evening Time${NC}      ${GRAY}║${NC}"
    echo -e "           ${GRAY}╚════════════════════════════════════╝${NC}"
    echo ""
    echo -e "                   ${BROWN}╔═══════════════╗${NC}"
    echo -e "                   ${BROWN}║${NC}  ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "        ${BROWN}╱───╲${NC}      ${BROWN}║${NC} ${YELLOW}┌─────────┐${NC} ${BROWN}║${NC}      ${WHITE}╭─╮${NC}"
    echo -e "       ${BROWN}╱     ╲${NC}     ${BROWN}║${NC} ${YELLOW}│Parmesan │${NC} ${BROWN}║${NC}      ${WHITE}│ │${NC}"
    echo -e "      ${BROWN}│  ${BRIGHT_RED}╱●╲${BROWN}  │${NC}    ${BROWN}║${NC} ${YELLOW}│ Cheese  │${NC} ${BROWN}║${NC}      ${WHITE}╰─╯${NC}"
    echo -e "      ${BROWN}│ ${BRIGHT_RED}│${RED}███${BRIGHT_RED}│${BROWN} │${NC}    ${BROWN}║${NC} ${YELLOW}└─────────┘${NC} ${BROWN}║${NC}    ${WHITE}Window${NC}"
    echo -e "      ${BROWN}│  ${BRIGHT_RED}╲●╱${BROWN}  │${NC}    ${BROWN}║${NC}             ${BROWN}║${NC}"
    echo -e "       ${BROWN}╲     ╱${NC}     ${BROWN}╚═══════════════╝${NC}"
    echo -e "        ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}           ${BROWN}║   ║   ║   ║${NC}"
    echo -e "       ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}          ${BROWN}║   ║   ║   ║${NC}"
    ...
    echo -e "    ${YELLOW}│${RED}≈${YELLOW}┴${RED}≈${YELLOW}SPAGHETTI${RED}≈${YELLOW}┴${RED}≈${YELLOW}│${NC}        ${BRIGHT_RED}● ${NC}= Delicious"
    echo -e "    ${YELLOW}│${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}│${NC}            Meatball!"
    ...
    echo -e "       ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}"
...
scene2_sneeze() {
    ...
    echo ""
    echo -e "           ${GRAY}╔════════════════════════════════════╗${NC}"
    echo -e "           ${GRAY}║${NC}    ${BRIGHT_RED}!!! OH NO - A SNEEZE !!!${NC}       ${GRAY}║${NC}"
    echo -e "           ${GRAY}╚════════════════════════════════════╝${NC}"
    echo ""
    echo -e "                   ${BROWN}╔═══════════════╗${NC}"
    echo -e "      ${CYAN}╔══╗${NC}         ${BROWN}║${NC}  ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${CYAN}║AH║${NC} ${BROWN}╱───╲${NC}     ${BROWN}║${NC} ${YELLOW}┌─────────┐${NC} ${BROWN}║${NC}      ${WHITE}╭─╮${NC}"
    echo -e "      ${CYAN}╚══╝${NC}${BROWN}╱     ╲${NC}    ${BROWN}║${NC} ${YELLOW}│Parmesan │${NC} ${BROWN}║${NC}      ${WHITE}│ │${NC}"
    echo -e " ${CYAN}* ╔════╗${NC}${BROWN}│  ${BRIGHT_RED}╱●╲${BROWN}  │${NC}   ${BROWN}║${NC} ${YELLOW}│ Cheese  │${NC} ${BROWN}║${NC}      ${WHITE}╰─╯${NC}"
    echo -e "${CYAN}* *║CHOO║${NC}${BROWN}│ ${BRIGHT_RED}│${RED}███${BRIGHT_RED}│${BROWN} │${NC}   ${BROWN}║${NC} ${YELLOW}└─────────┘${NC} ${BROWN}║${NC}"
    echo -e "${CYAN}*  ╚════╝${NC}${BROWN}│  ${BRIGHT_RED}╲●╱${BROWN}  │${NC}   ${BROWN}║${NC}             ${BROWN}║${NC}"
    echo -e " ${CYAN}*  * ${NC}   ${BROWN}╲     ╱${NC}    ${BROWN}╚═══════════════╝${NC}"
    echo -e "   ${CYAN}*${NC}      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}          ${BROWN}║   ║   ║   ║${NC}"
    echo -e "         ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}         ${BROWN}║   ║   ║   ║${NC}"
    echo -e "        ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "       ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}     ${BROWN}║   ║   ║   ║${NC}"
    echo -e "      ${YELLOW}│${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}│${NC}    ${BROWN}╚═══╩═══╩═══╝${NC}"
    echo -e "      ${YELLOW}│${RED}≈${YELLOW}┴${RED}≈${YELLOW}SPAGHETTI${RED}≈${YELLOW}┴${RED}≈${YELLOW}│${NC}       ${BRIGHT_RED}The meatball"
    echo -e "      ${YELLOW}│${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}│${NC}       ${BRIGHT_RED}starts to wobble!${NC}"
    echo -e "       ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}"
    echo -e "        ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}"
    echo -e "         ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}"
    echo -e "          ${YELLOW}╲_____╱${NC}"
...
# Animation: Meatball Rolling Off - Enhanced with 6 frames
animate_roll() {
    play_animation_music

    # Frame 1: Meatball starts to tip
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}  ${BRIGHT_RED}The meatball begins to roll!${NC}  ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}"
    echo -e "     ${BROWN}│ ${BRIGHT_RED}╱●╲${NC}   ${BROWN}│${NC}  ${BROWN}║${NC}  ${YELLOW}│Parmesan │${NC}  ${BROWN}║${NC}"
    echo -e "     ${BROWN}│${BRIGHT_RED}│${RED}███${BRIGHT_RED}│${NC}  ${BROWN}│${NC}  ${BROWN}║${NC}  ${YELLOW}└─────────┘${NC}  ${BROWN}║${NC}"
    echo -e "     ${BROWN}│ ${BRIGHT_RED}╲●╱${NC}   ${BROWN}│${NC}  ${BROWN}╚═══════════════╝${NC}"
    echo -e "      ${BROWN}╲     ╱${NC}      ${BROWN}║   ║   ║   ║${NC}"
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}      ${BROWN}╚═══╩═══╩═══╝${NC}"
    pause 0.2

    # Frame 2: Meatball falls off plate
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}      ${BRIGHT_RED}It's falling down!${NC}        ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}║${NC}  ${YELLOW}│Parmesan │${NC}  ${BROWN}║${NC}   ${BRIGHT_RED}╱●╲${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}║${NC}  ${YELLOW}└─────────┘${NC}  ${BROWN}║${NC}  ${BRIGHT_RED}│${RED}███${BRIGHT_RED}│${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}╚═══════════════╝${NC}   ${BRIGHT_RED}╲●╱${NC}"
    echo -e "      ${BROWN}╲     ╱${NC}      ${BROWN}║   ║   ║   ║${NC}"
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}      ${BROWN}╚═══╩═══╩═══╝${NC}"
    pause 0.2

    # Frame 3: Meatball bounces on plate edge
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}        ${BRIGHT_RED}Bouncing...${NC}           ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}"
    ...
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}╚═══════════════╝${NC}"
    echo -e "      ${BROWN}╲     ╱${NC}      ${BROWN}║   ║   ║   ║${NC}     ${BRIGHT_RED}●${NC}"
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC} ${BRIGHT_RED}●${NC}    ${BROWN}║   ║   ║   ║${NC}    ${RED}≈${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC} ${RED}≈${NC}   ${BROWN}╚═══╩═══╩═══╝${NC}"
    pause 0.2

    # Frame 4: Meatball rolls on floor
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}    ${BRIGHT_RED}Rolling across the floor!${NC}    ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}"
    ...
    echo -e "      ${BROWN}╲     ╱${NC}      ${BROWN}║   ║   ║   ║${NC}"
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}      ${BROWN}╚═══╩═══╩═══╝${NC}   ${BRIGHT_RED}●${NC}  ${RED}≈≈${NC}"
    echo -e "  ${GRAY}═══════════════════════════════════${NC}  ${RED}≈≈≈${NC}"
    pause 0.2

    # Frame 5: Meatball speeds up
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}    ${BRIGHT_RED}Faster and faster...${NC}       ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}"
    ...
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}      ${BROWN}╚═══╩═══╩═══╝${NC}"
    echo -e "  ${GRAY}═══════════════════════════════════════${NC}    ${BRIGHT_RED}●${NC}  ${RED}≈≈≈${NC}"
    echo -e "                                              ${RED}≈≈≈≈${NC}"
    pause 0.2

    # Frame 6: Heading toward door
    clear_screen
    echo ""
    echo -e "          ${GRAY}╔════════════════════════════════╗${NC}"
    echo -e "          ${GRAY}║${NC}   ${BRIGHT_RED}Heading for the door!${NC}        ${GRAY}║${NC}"
    echo -e "          ${GRAY}╚════════════════════════════════╝${NC}"
    echo -e "                ${BROWN}╔═══════════════╗${NC}         ${CYAN}╔══════╗${NC}"
    echo -e "       ${BROWN}╱───╲${NC}    ${BROWN}║${NC}   ${GRAY}~ Kitchen ~${NC}  ${BROWN}║${NC}         ${CYAN}║ DOOR ║${NC}"
    echo -e "      ${BROWN}╱     ╲${NC}   ${BROWN}║${NC}  ${YELLOW}┌─────────┐${NC}  ${BROWN}║${NC}         ${CYAN}║  ${WHITE}▓▓${CYAN}  ║${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}║${NC}  ${YELLOW}│Parmesan │${NC}  ${BROWN}║${NC}         ${CYAN}║      ║${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}║${NC}  ${YELLOW}└─────────┘${NC}  ${BROWN}║${NC}  ${BRIGHT_RED}●${NC}     ${CYAN}║  ${RED}→${CYAN}   ║${NC}"
    echo -e "     ${BROWN}│       │${NC}  ${BROWN}╚═══════════════╝${NC}  ${RED}≈≈≈${NC}    ${CYAN}║      ║${NC}"
    echo -e "      ${BROWN}╲     ╱${NC}      ${BROWN}║   ║   ║   ║${NC}  ${RED}≈≈≈${NC}    ${CYAN}╚══════╝${NC}"
    echo -e "      ${YELLOW}╲${RED}≈${YELLOW}┴${RED}≈${YELLOW}╱${NC}       ${BROWN}║   ║   ║   ║${NC}"
    echo -e "     ${YELLOW}╱${RED}≈${YELLOW}┴${RED}≈${YELLOW}┴${RED}≈${YELLOW}╲${NC}      ${BROWN}╚═══╩═══╩═══╝${NC}"
    echo -e "  ${GRAY}═══════════════════════════════════════${NC}"
